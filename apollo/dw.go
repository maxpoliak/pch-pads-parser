...
func (dw *dwcfg) getRxTxEnableConfig() uint8 {
	return dw.getFieldVal(0, rxtxEnableConfigMask, rxtxEnableConfigShift)
}
...
func (dw *dwcfg) getIOStandbyState() uint8 {
	return dw.getFieldVal(1, ioStandbyStateMask, ioStandbyStateShift)
}
